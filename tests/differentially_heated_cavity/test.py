...
def test_ldc():
    ...
    data,xp,yp,zp,xu,yv,zw = read_single_field_binary("data/","sca_001_fld_0010000.bin",np.array([1,1,1]))
    ...
    data,xp,yp,zp,xu,yv,zw = read_single_field_binary("data/","vex_fld_0010000.bin",np.array([1,1,1]))
    islice = int(np.size(data[0,0,:])/2)
    umax = np.max(data[islice,0,:]+data[islice+1,0,:])/2
    data,xp,yp,zp,xu,yv,zw = read_single_field_binary("data/","vez_fld_0010000.bin",np.array([1,1,1]))
    islice = int(np.size(data[0,0,:])/2)
